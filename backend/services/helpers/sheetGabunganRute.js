...
async function generateSheetGabunganRute(
  workbook,
  rute,
  kapalList,
  sheetNamesLBR,
  ...
  let sheetName = `Gab. ${rute.nama_rute}`;
  ...
  console.log(`Generating combined sheet: ${finalSheetName}`);
  ...
  const namaSemuaKapal = kapalList.map(k => getNamaPendekKapal(k.nama_kapal)).join(" & ");
  const namaKapalDisplay = `KMP. ${namaSemuaKapal}`;
  const lintasan = `${pelabuhanAsal.toUpperCase()} - ${pelabuhanTujuan.toUpperCase()} (GABUNGAN)`;

  // Hitung total kapasitas dari semua kapal
  const totalKapasitasPenumpang = kapalList.reduce((sum, k) => sum + (parseInt(k.kapasitas_penumpang) || 0), 0);
  const totalKapasitasKendaraan = kapalList.reduce((sum, k) => sum + (parseInt(k.kapasitas_kendaraan) || 0), 0);
  ...
  const sumF = (row) => sheetNamesLBR.map(n => `'${n}'!F${row}`).join('+');
  const sumE = (row) => sheetNamesLBR.map(n => `'${n}'!E${row}`).join('+');
  const sumI = (row) => sheetNamesLBR.map(n => `'${n}'!I${row}`).join('+');
  const sumJ = (row) => sheetNamesLBR.map(n => `'${n}'!J${row}`).join('+');

  // Helper untuk cari tarif dari database
  ...
  // Hitung data penumpang dan kendaraan dari produksi untuk mendapatkan tarif diskon
  ...
  // Hitung detail dari produksi
  const pnpDetail = hitungPenumpangDetail(produksiRute);
  const kndDetail = hitungKendaraanDetail(produksiRute);

  // Tarif penumpang dari database atau dari data produksi
  ...
  // Tarif kendaraan per row
  const tarifPerRow = {};
  const tarifDiskonPerRow = {};
  GOL_ROW_MAP.forEach((g) => {
    ...
    tarifDiskonPerRow[g.row] = detail?.tarifDiskon || null;
  });
  ...
  sc("D7", `: ${pelabuhanAsal.toUpperCase()} - ${pelabuhanTujuan.toUpperCase()} (PP)`, { bold: true, size: 14 });
  ...
  b(e20);
  const f20 = ws.getCell("F20");
  f20.value = ""; // Kosongkan F20
  b(f20);
  ...
  brsStd(25, "", "1) Eksekutif", null, { formula: sumE(25) }, null, null, null);
  brsStd(26, "", "- Dewasa", null, { formula: sumE(26) }, null, null, null);
  brsStd(27, "", "- Anak", null, { formula: sumE(27) }, null, null, null);
  brsStd(28, "", "- Bayi", null, { formula: sumE(28) }, null, null, null);

  brsStd(29, "", "2) Bisnis I", null, { formula: sumE(29) }, null, null, null);
  brsStd(30, "", "- Dewasa", null, { formula: sumE(30) }, null, null, null);
  brsStd(31, "", "- Anak", null, { formula: sumE(31) }, null, null, null);
  brsStd(32, "", "- Bayi", null, { formula: sumE(32) }, null, null, null);

  brsStd(33, "", "3) Bisnis II", null, { formula: sumE(33) }, null, null, null);
  brsStd(34, "", "- Dewasa", null, { formula: sumE(34) }, null, null, null);
  brsStd(35, "", "- Anak", null, { formula: sumE(35) }, null, null, null);
  brsStd(36, "", "- Bayi", null, { formula: sumE(36) }, null, null, null);

  brsStd(37, "", "4) Ekonomi", null, { formula: sumE(37) }, null, null, null);
  
  // Tarif penumpang - gunakan nilai dari database dan data produksi
  brsStd(38, "", "- Dewasa", tarifDewasaNormal, { formula: sumE(38) }, { formula: sumF(38) }, sumI(38), sumJ(38));
  brsStd(39, "", "- Dewasa (Diskon)", tarifDewasaDiskon, { formula: sumE(39) }, { formula: sumF(39) }, sumI(39), sumJ(39));
  brsStd(40, "", "- Anak", tarifAnakNormal, { formula: sumE(40) }, { formula: sumF(40) }, sumI(40), sumJ(40));
  brsStd(41, "", "- Anak (Diskon)", tarifAnakDiskon, { formula: sumE(41) }, { formula: sumF(41) }, sumI(41), sumJ(41));
  ...
  brsStd(43, "", "5) Suplesi", null, { formula: sumE(43) }, null, null, null);
  brsStd(44, "", "- Eksekutif", null, { formula: sumE(44) }, null, null, null);
  brsStd(45, "", "- Bisnis I", null, { formula: sumE(45) }, null, null, null);
  brsStd(46, "", "- Bisnis II Dewasa", null, { formula: sumE(46) }, null, null, null);
  brsStd(47, "", "- Bisnis II Anak", null, { formula: sumE(47) }, null, null, null);
  ...
  GOL_ROW_MAP.forEach((g, i) => {
    // Tarif kendaraan - gunakan nilai dari database
    const tarifNormal = tarifPerRow[currentRow];
    brsStd(currentRow, "", golLabel[i], tarifNormal, { formula: sumE(currentRow) }, { formula: sumF(currentRow) }, sumI(currentRow), sumJ(currentRow));
    currentRow++;
    
    // Tarif diskon dari data produksi
    const tarifDiskon = tarifDiskonPerRow[currentRow - 1]; // currentRow sudah increment, jadi -1
    brsStd(currentRow, "", golLabel[i] + " (Diskon)", tarifDiskon, { formula: sumE(currentRow) }, { formula: sumF(currentRow) }, sumI(currentRow), sumJ(currentRow));
    currentRow++;
  });
  ...
  brsStd(77, "", "- Penumpang (%)", null, { formula: sumE(77) }, null, null, null);
  brsStd(78, "", "- Kendaraan (%)", null, { formula: sumE(78) }, null, null, null);
  ...
  brsStd(81, "", "1) Ton/M Kubik", null, { formula: sumE(81) }, null, null, null);
  brsStd(82, "", "2) Brg curah/M Kubik", null, { formula: sumE(82) }, null, null, null);
  brsStd(83, "", "3) Brg tentengan/kg", null, { formula: sumE(83) }, null, null, null);
...
module.exports = { generateSheetGabunganRute };
